      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <a href="index.html" class="site_title"><img src="images/poshub.png" width="100px" height="50px" style="padding-bottom:7px;"> <span></span></a>
            </div>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-success btn-xs">On Progress</button>
                          </td>
                          <td>
                            <a href="project_detail_projek.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
